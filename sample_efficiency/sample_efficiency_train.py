...
def main(unused_argv):
  ...
  downstream_regression_train_gin_bindings = [
      ...
      "downstream_regression_on_representations.num_train = [5]", #[127500]",
      "downstream_regression_on_representations.num_test = 5", #22500",
      "downstream_regression_on_representations.num_holdout = 5", #80000", 
